...
SAMPLE_RESULTS = [
    {
        ...
        "scoring": {
            "ml_readiness": {"score": 88, "label": "High", "interpretation": "Well-suited"},
            "druglikeness": {
                "qed_score": 0.75,
        ...
        "standardization": {
            ...
            "success": True,
            "steps_applied": [{"step_name": "normalize", "applied": True}],
            "excluded_fragments": [],
        },
        "safety_assessment": {
    ...
    },
    {
        ...
        "alerts": {
            ...
            "brenk": {"matches": []},
            "alerts": [
                {"catalog": "PAINS", "pattern_name": "anil_di_alk_D(258)"},
            ],
        },
        "scoring": {
            "ml_readiness": {"score": 75, "label": "Medium", "interpretation": "Moderate"},
            "druglikeness": {
                "qed_score": 0.32,
                "lipinski_passed": True,
                "lipinski_violations": 0,
