"""
Batch processing examples for ChemStructVal client.
...
from chemstructval.exceptions import TimeoutError, APIError
...
def main():
    print("ChemStructVal Client - Batch Processing Examples\n")
    print("=" * 60)
