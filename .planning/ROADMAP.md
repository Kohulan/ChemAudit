...
- [ ] **Phase 2: Standardization Intelligence** - Provenance tracking for all 4 ChEMBL pipeline stages with atom-level change reporting
...
Plans:
- [ ] 01-01-PLAN.md — M1.1 Stereo & Tautomer Checks backend (DVAL-01..05) + cache key versioning
...
**Plans**: TBD — 2 plans (one per milestone: M2.1, M2.2)

Plans:
- [ ] 02-01: Milestone 2.1 — Standardization Provenance (STD-01 through STD-04)
- [ ] 02-02: Milestone 2.2 — Normalization & Stereo Cleanup Reports (STD-05, STD-06)
...
| 2. Standardization Intelligence | v2.0 | 0/2 | Not started | - |
